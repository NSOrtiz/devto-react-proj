...
const ListTags = ["#javascript", "#vue", "#nuxt", "#react", "#webdev", "#programming","#aws", "#codeopen", "#frontend", "#linux", "testing", "#codepen", "#html", "#ai", "mobile" ]
        ...
        <div className="flex flex-row gap-2">
            {
                randomTagsList.map((tag, idx)=>{
                    return (
                        <label key={`tag-${tag}`} className={clsx("font-light text-gray-600 text-sm cursor-pointer p-1", {
                            ...
                            "hover:bg-blue-100 hover:border hover:border-blue-500 hover:rounded": idx===3})}>{tag}</label>
